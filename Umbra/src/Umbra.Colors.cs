...
internal class UmbraColors
{
    ...
    public static void RegisterDefaultColors()
    {
        ...
        Color.AssignByName("Widget.PopupMenuTextOutlineDisabled", 0xA0000000);

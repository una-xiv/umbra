...
internal partial class WeatherWidgetPopup : WidgetPopup
{
    ...
    public I18N.TimeFormat TimeFormat { get; set; } = I18N.TimeFormat.Long;
    ...
    protected override void OnUpdate()
    {
        ...
        for (var i = 1; i < 9; i++) {
            ...
            node.QuerySelector(".text > .text-bottom")!.NodeValue = I18N.FormatTime(forecastItem.TimeSpan, TimeFormat);
        }
    }
}

...
public partial class GameIconPickerWindow
{
    private static Dictionary<string, List<(uint, uint)>> Categories { get; } = new() {
        {
            "General", [
                (0, 95), (97, 97), (101, 132), (651, 652), (654, 655), (695, 698), (66001, 66001), (66021, 66023),
                ...
                (66401, 66423), (66452, 66473), (60001, 6004), (60011, 60013), (60026, 60049), (60071, 60074),
                (61471, 61489), (61501, 61548), (61551, 61598), (61751, 61768), (61801, 61853), (61855, 61856),
                (61875, 61880)
            ]
        }, {
            "Jobs", [
                (0, 0), (62001, 62043), (62801, 62843), (62226, 62268), (62101, 62143), (62301, 62320), (62401, 62423),
                (82271, 82294), // Phantom Jobs
            ]
        }, {
            "Quests", [
                (0, 0),

...
public sealed partial class IconPickerWindow(uint iconId) : Window
{
    ...
    private static Dictionary<string, List<(uint, uint)>> Categories { get; } = new() {
        ...
        { "Jobs", [(62001, 62042), (62801, 62842), (62226, 62267), (62101, 62142), (62301, 62320), (62401, 62422)] }, {
            "Quests",
            [
        ...
        { "Avatars", [(76951, 76994), (62145, 62146), (72001, 72059), (72556, 72607)] },
        { "Emotes", [(64001, 64099), (64101, 64133), (64151, 64154), (64326, 64452)] },
        { "Rewards", [(65001, 65110)] }, {
            "MapMarkers",
            [
        ...
        { "Minions", [(4401, 4926), (59401, 59926)] },
        { "Mounts", [(4001, 4098), (4101, 4293)] },
    };

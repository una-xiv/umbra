...
/// <summary>
/// Marks a static method that should be called when the framework is disposing.
/// </summary>
[AttributeUsage(AttributeTargets.Method)]
public class WhenFrameworkDisposingAttribute(int executionOrder = 0) : Attribute, IExecutionOrderAware
{
